...
/* 26 */
/*!************************************************!*\
  !*** C:/Users/chejun/Desktop/woerp/pages.json ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 39 */
/*!****************************************************!*\
  !*** C:/Users/chejun/Desktop/woerp/common/util.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 56 */
/*!************************************************************!*\
  !*** C:/Users/chejun/Desktop/woerp/common/materialData.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.materialSearch = exports.materialDatabase = exports.MaterialSearch = void 0;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
var MaterialSearch = /*#__PURE__*/function () {
  function MaterialSearch() {
    (0, _classCallCheck2.default)(this, MaterialSearch);
    this.materials = materialDatabase;
  }

  // 拼音转换（简易版）
  (0, _createClass2.default)(MaterialSearch, [{
    key: "pinyinConvert",
    value: function pinyinConvert(text) {
      var pinyinMap = {
        '磷酸铁锂': 'linsuan tieli',
      ...
      var result = text;
      Object.keys(pinyinMap).forEach(function (key) {
    ...
    value: function search(keyword) {
      ...
      this.materials.forEach(function (material) {
        ...
        var code = material.code.toLowerCase();
        var category = material.category.toLowerCase();
        var pinyin = material.pinyin.toLowerCase();
        var supplier = material.supplier.toLowerCase();
        var spec = material.spec.toLowerCase();
        ...
        if (score > 0) {
          results.push(_objectSpread(_objectSpread({}, material), {}, {
            searchScore: score
          }));
        }
      });
    ...
    key: "getHotKeys",
    value: function getHotKeys() {
      return ['磷酸铁锂', '三元材料', '石墨', '电解液', '隔膜', '导电炭黑', 'NCM', 'LFP'];
    }

    // 获取分类统计
  }, {
    key: "getCategoryStats",
    value: function getCategoryStats() {
      var stats = {};
      this.materials.forEach(function (material) {
    ...
    key: "getLowStockWarning",
    value: function getLowStockWarning() {
      var threshold = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 500;
...
exports.MaterialSearch = MaterialSearch;
var materialSearch = new MaterialSearch();
exports.materialSearch = materialSearch;
...
/* 76 */
/*!********************************************************!*\
  !*** C:/Users/chejun/Desktop/woerp/store/constants.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.OUTBOUND_TYPES = OUTBOUND_TYPES;
